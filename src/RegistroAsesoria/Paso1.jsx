          ...
          <div className="grid gap-12 grid-cols-1 lg:space-y-0 lg:text-center md:grid-cols-3">
            <div>
              ...
              >
                <div className="items-center justify-center text-accent-500 bg-gray-100 rounded-xl flex h-20 w-20 lg:mx-auto">
                  <img src="/1.jpg" alt="Imagen maestra Gabriela" className="rounded-lg"/>
                </div>
            ...
            <div>
              ...
              >
                <div>
                  <div className="items-center justify-center text-accent-500 bg-gray-100 rounded-xl flex h-20 w-20 lg:mx-auto">
                    <img src="/2.jpeg" alt="Imagen doctora Roxana" className="rounded-lg"/>
                  </div>
                  <p className="mt-4 text-lg font-semibold leading-6 text-black font-display tracking-tight">
            ...
            <div>
              ...
              >
                <div>
                  <div className="items-center justify-center text-accent-500 bg-gray-100 rounded-xl flex h-20 w-20 lg:mx-auto">
                    <img src="/3.jpg" alt="Imagen doctora Eugenia" className="rounded-lg"/>
                  </div>
                  <p className="mt-4 text-lg font-semibold leading-6 text-black font-display tracking-tight">
            ...
            <div>
              ...
              >
                <div>
                  <div className="items-center justify-center text-accent-500 bg-gray-100 rounded-xl flex h-20 w-20 lg:mx-auto">
                    <img src="/4.jpg" alt="Imagen maestra Kirina" className="rounded-lg"/>
                  </div>
                  <p className="mt-4 text-lg font-semibold leading-6 text-black font-display tracking-tight">
            ...
            <div>
              ...
              >
                <div>
                  <div className="items-center justify-center text-accent-500 bg-gray-100 rounded-xl flex h-20 w-20 lg:mx-auto">
                    <img src="/5.jpeg" alt="Imagen maestra Victoria" className="rounded-lg"/>
                  </div>
                  <p className="mt-4 text-lg font-semibold leading-6 text-black font-display tracking-tight">
            ...
            <div>
              ...
              >
                <div>
                  <div className="items-center justify-center text-accent-500 bg-gray-100 rounded-xl flex h-20 w-20 lg:mx-auto">
                    <img src="/6.jpeg" alt="Imagen maestra Josefina" className="rounded-lg"/>
                  </div>
                  <p className="mt-4 text-lg font-semibold leading-6 text-black font-display tracking-tight">
                    Mtra. Josefina Tapia
                  </p>
